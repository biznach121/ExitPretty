...
export const brand: Brand = {
  name: "Exit Pretty Nails",
  shortName: "Exit Pretty",
  microTag: "YOU ALWAYS EXIT PRETTY",
  description:
    "Exit Pretty Nails in Accra is where nails get the time and detail they deserve — clean sets, careful prep and finishes that last.",
  ...
  contact: {
    ...
    countryCode: "GH",
    phone: "0551382914",
    phoneTel: "+233551382914",
    textPhone: "0551382914",
    textPhoneTel: "+233551382914",
    email: "hello@exitpretty.test",
    privacyEmail: "privacy@exitpretty.test",
    hours: "Call or text to book",
  },

  socials: [
    { label: "TikTok", href: "https://www.tiktok.com/@najat_nailtech", icon: "tiktok" },
  ],
  ...
  editorial: {
    ...
    notes: [
      ...
      {
        body: "Exit Pretty Nails exists so that slowing down doesn't cost you your rhythm. One hour here gives back more than it takes — a genuine reset with a visible result.",
    ...
    images: [
      {
        ...
        alt: "Exit Pretty Nails beauty treatment detail",
      ...
      },
      {
        ...
        alt: "Exit Pretty Nails self-care treatment",
        className: "right-[5%] top-[15%] h-[255px] w-[155px] rounded-[999px]",
        sizes: "155px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Exit Pretty Nails beauty ritual",
      ...
      },
      {
        ...
        alt: "Exit Pretty Nails calm care moment",
        className: "right-[6%] top-[68%] h-[145px] w-[100px] rounded-[999px]",
        sizes: "100px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Exit Pretty Nails relaxation detail",
        className: "left-[25%] top-[75%] h-[150px] w-[102px] rounded-[999px]",
        sizes: "102px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/bgkgjrchbkhtckgh9f7t.jpg",
        alt: "Exit Pretty Nails beauty and peace detail",
    ...
    items: [
      {
        ...
        imageAlt: "Exit Pretty Nails lip gloss product",
        tone: "light",
      },
      {
        name: "mint\nbeauty oil",
        ...
        imageAlt: "Exit Pretty Nails mint oil product",
        tone: "olive",
      },
      {
        name: "brush\nessentials",
        ...
        imageAlt: "Exit Pretty Nails makeup brush set",
        tone: "light",
      },
      {
        name: "smooth\nfoundation",
        ...
        imageAlt: "Exit Pretty Nails foundation product",
        tone: "olive",
      },
    ],
  },
  ...
  media: {
    title: "media",
    ctaLabel: "Follow",
    ctaHref: "https://www.tiktok.com/@najat_nailtech",
    images: [
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783490643/stage4/spa_najatnailtech/tiktok_0.mp4",
        alt: "Exit Pretty Nails treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783490716/stage4/spa_najatnailtech/tiktok_1.mp4",
        alt: "Exit Pretty Nails treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581429/hptukehgmrufp33qyd5e.mp4",
        alt: "Exit Pretty Nails salon media video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581430/gse4jxivlcejlrtq3fjk.mp4",
        alt: "Exit Pretty Nails self-care media video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581409/pq6ritvfxvxkhsjqkct4.mp4",
        alt: "Exit Pretty Nails studio media video",
        position: "center",
      },
    ],
  },
  ...
  about: {
    eyebrow: "About Exit Pretty Nails",
    title: "Your sanctuary\nof beauty and peace.",
    paragraphs: [
      "Exit Pretty Nails is a curated beauty and self-care space in Accra, created for the moments when you want to feel polished, calm, and cared for without rushing through the process.",
    ...
    sections: [
      ...
      {
        heading: "Visit",
        body: "Find us in Accra. Use the Location page for the exact Google Maps pin, or call 0551382914 and text 0551382914 for booking help.",
      },
    ],
  },
  ...
  faq: {
    ...
    sections: [
      {
        ...
        items: [
          { q: "How do I book?", a: "Use the Book page, call 0551382914, text 0551382914, or message @najat_nailtech on Instagram." },
          ...
          { q: "Where are you located?", a: "Exit Pretty Nails is in Accra. The Location page has the exact Google Maps pin." },
        ],
      },
      {
        title: "Treatments",
    ...
    contactEmail: "hello@exitpretty.test",
  },
  ...
  terms: {
    ...
    sections: [
      { heading: "1. Who we are", body: "Exit Pretty Nails (\"we\", \"us\") is a beauty and self-care business in Accra, Ghana. By booking a service or buying a product, you agree to these terms." },
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: "Your rights", body: "Under the Ghana Data Protection Act, 2012 (Act 843), you can access, correct, or delete your data. Email privacy@exitpretty.test." },
  ...
  shipping: {
    ...
    sections: [
      ...
      { heading: "Location", body: "Exit Pretty Nails is in Accra. Visit the Location page for the exact Google Maps pin." },
  ...
  accessibility: {
    ...
    sections: [
      ...
      { heading: "Reporting issues", body: "Email accessibility@exitpretty.test, call, or text the studio. We respond within a business day." },
    ],
  },

  account: {
    loginEyebrow: "Welcome back",
    loginTitle: "Sign in to Exit Pretty Nails",
  ...
  contactPage: {
    ...
    directLines: [
      { label: "Call", value: "0551382914", href: "tel:+233551382914" },
      { label: "Text", value: "0551382914", href: "sms:+233551382914" },
      { label: "Instagram", value: "@najat_nailtech", href: "https://www.tiktok.com/@najat_nailtech" },
    ],
  },
  ...
  footer: {
    blurb:
      "Exit Pretty Nails in Accra — you always exit pretty.",
    sitemap: [
      {
        title: "Visit",
        links: [
          ...
          { label: "Location", href: "/location" },
          { label: "Instagram", href: "https://www.tiktok.com/@najat_nailtech" },
        ],
      },
      {
        title: "Studio",
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Call 0551382914", href: "tel:+233551382914" },
          { label: "Text 0551382914", href: "sms:+233551382914" },
        ],
      },
      {
        title: "Account",
  ...
  llms: {
    summary:
      "Exit Pretty Nails — beauty and self-care in Accra. Lashes, brows, nails, pedicure, waxing, piercing, facials, massage, and beauty products. Booking via website, call, text, or Instagram.",
  },
