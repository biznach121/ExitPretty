...
const LOGO_URL =
  "https://res.cloudinary.com/dzykdnbvb/raw/upload/v1783490641/stage4/spa_najatnailtech/logo.svg";
...
export function SpaBoxLogo({ className = "", compact = false, tone = "light" }: SpaBoxLogoProps) {
  ...
  if (REAL_LOGO) {
    ...
    return (
      <span className={["relative inline-block", sizeClass, className].join(" ")} aria-label="Exit Pretty Nails - You always exit pretty">
        <Image
          src={src}
          alt="Exit Pretty Nails - You always exit pretty"
          fill
